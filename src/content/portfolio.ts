...
const norwegian = {
  ...
  podcast: {
    ...
    description: "Hva om du kunne snakke med en podkast? En AI-prototype som lar deg stille spørsmål og høre akkurat hvor i opptaket svaret kommer fra. Prototypen bruker RAG og vektorsøk i PostgreSQL med pgvector for å hente relevante utdrag fra transkripsjonen som grunnlag for svarene.",
...
const english: typeof norwegian = {
  ...
  podcast: {
    ...
    description: "What if you could talk to a podcast? An AI prototype that lets you ask questions and hear exactly where in the recording the answer comes from. The prototype uses RAG and vector search in PostgreSQL with pgvector to retrieve relevant transcript excerpts as context for its answers.",
